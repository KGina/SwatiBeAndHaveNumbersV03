    ...
    class FullHundred : Number
    {
        ...
        public override string lang()
        {
            ...
            if (language.langaugeName == "Basaa")
            {
                ...
                if ((m >= 2) && (m <= 9))
                {
                    result = "ni " + result + " ni " + propStemBasaa[m - 1];
                }
